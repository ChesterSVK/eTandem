...
export const TandemFeedbackMails = {
    ...
    // All types of mails, types can be skipped or removed in later stages of development if needed so far only three
    // types of emails were needed. More info in tandemSendEmail.js server method.
	types: {
        REPORT : "Report",
        UNMATCH : "Unmatch",
